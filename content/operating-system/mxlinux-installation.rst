...
* `default background image <adrien-olichon-RCAhiGJsUUE-unsplash.jpg>`_
* gnome-disk-utility(auto mount drive)
* view log(tried: gnome-system-log,\ `glogg <https://glogg.bonnefon.org/>`_\ ,journalctl(default installed))
...
#. https://gist.github.com/lxneng/1031014#file-gistfile1-txt
#. https://stackoverflow.com/a/3016986
#. https://github.com/scottcorgan/bucket-list/issues/2#issuecomment-40327294
#. https://stackoverflow.com/q/9500898
...
Install it from MX Package Installer, :raw-html-m2r:`<del>but need install geoclue2: ``sudo apt-get install geoclue-2.0``\ </del>` geoclue had been installed.
...
from `here <https://github.com/jonls/redshift/issues/318#issue-134184111>`_\ , I got a way:


#. Run as ``sudo redshift-gtk``
...
需要安装 ``rtl8821ce``\ （\ `link <https://github.com/tomaspinho/rtl8821ce>`_\ ）
...
#. 
   UEFI 应该安装MSR grub引导，我安装了 MBR 启动时，找不到引导显示硬盘不存在

#. 
   很卡，重启之后，蓝牙键盘能链接了，不卡了

#. 
   直接选择重启后进入了tty1终端，日志报错：
...
#. 用 MXpackage installer 删除包，会卡
#. 刚才，重启一次 VM VirtualBox 又卡，等了近 5 分钟不卡了

ref:


#. https://www.linuxquestions.org/questions/linux-hardware-18/i%27m-not-sure-if-i%27m-using-my-dedicated-gpu-how-can-i-switch-4175679340/
#. https://forum.mxlinux.org/viewtopic.php?t=44035
#. https://mxlinux.org/wiki/hardware/nvidia-driver-install-recovery/
#. https://serverfault.com/a/1005911
#. https://forum.mxlinux.org/viewtopic.php?p=486414&sid=acef60993a8c8bcdc55f8965e6cc50b6#p486414
