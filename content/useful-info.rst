...
#. relatively easy to create and edit files
#. the main feature that distinguishes ePUB from PDF files is its ability to rearrange content
#. the ability to add media files (audio, video, rich images)
#. supports multiple readers
#. a favorite of e-bookstores
#. provides higher security than PDF
