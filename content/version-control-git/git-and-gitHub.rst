...
在 Github Actions 出来之前，比较流行的开源 CI 服务分别是 `CircleCI <https://circleci.com/>`_ 以及 `TravisCI <https://travis-ci.org/>`_\ 。之前也有一些项目使用过这些第三方服务，但给人的体验都不是很好例如构建缓慢。特别是对于国内用户来说访问它们的资源实在是太慢了，并且它们自身的功能也存在一点缺失。

**Github Actions**

接下来让我们看看应用要如何接入 `Github Actions <https://docs.github.com/cn/free-pro-team@latest/actions>`_
以 `create-ssr-app <https://github.com/zhangyuang/create-ssr-app>`_ 为例
...
.. image:: https://res.wx.qq.com/op_res/fIHeA-ZVJ229K_xpIR2QiyVyH3ZTwtKqmQzM_e6AVZHXAxRw2q1qlWHrmqJ20xhP
   :target: https://res.wx.qq.com/op_res/fIHeA-ZVJ229K_xpIR2QiyVyH3ZTwtKqmQzM_e6AVZHXAxRw2q1qlWHrmqJ20xhP
   :alt: 
...
.. image:: https://res.wx.qq.com/op_res/A2UVQnCR7s9y5uggqAWM2NK-V6PJOMpSKY7wA7aGKZ2GZUD123KVykc7yk8UGbmo
   :target: https://res.wx.qq.com/op_res/A2UVQnCR7s9y5uggqAWM2NK-V6PJOMpSKY7wA7aGKZ2GZUD123KVykc7yk8UGbmo
   :alt: 
...
`source <https://github.com/mayandev/gh-short-url#before-use>`_
...
#. https://github.community/t/unable-to-push-to-repo-gnutls-handshake-failed/885/19
#. https://askubuntu.com/a/1009764
