...
[](#Documentation/gitglossary.txt-aiddefbarerepositoryabarerepository)bare repository
...
[](#Documentation/gitglossary.txt-aiddefblobobjectablobobject)blob object

Untyped [object](#def_object), e.g. the contents of a file.

[](#Documentation/gitglossary.txt-aiddefbranchabranch)branch
...
[](#Documentation/gitglossary.txt-aiddefcacheacache)cache

Obsolete for: [index](#def_index).

[](#Documentation/gitglossary.txt-aiddefchainachain)chain
...
[](#Documentation/gitglossary.txt-aiddefchangesetachangeset)changeset
...
[](#Documentation/gitglossary.txt-aiddefcheckoutacheckout)checkout
...
[](#Documentation/gitglossary.txt-aiddefcherry-pickingacherry-picking)cherry-picking
...
[](#Documentation/gitglossary.txt-aiddefcleanaclean)clean
...
[](#Documentation/gitglossary.txt-aiddefcommitacommit)commit
...
[](#Documentation/gitglossary.txt-aiddefcommitobjectacommitobject)commit object
...
[](#Documentation/gitglossary.txt-aiddefcommit-ishacommit-ishalsocommittish)commit-ish (also committish)
...
[](#Documentation/gitglossary.txt-aiddefcoregitacoreGit)core Git

Fundamental data structures and utilities of Git. Exposes only limited source code management tools.

[](#Documentation/gitglossary.txt-aiddefDAGaDAG)DAG
...
[](#Documentation/gitglossary.txt-aiddefdanglingobjectadanglingobject)dangling object
...
[](#Documentation/gitglossary.txt-aiddefdetachedHEADadetachedHEAD)detached HEAD
...
[](#Documentation/gitglossary.txt-aiddefevilmergeaevilmerge)evil merge

An evil merge is a [merge](#def_merge) that introduces changes that do not appear in any [parent](#def_parent).

[](#Documentation/gitglossary.txt-aiddeffastforwardafast-forward)fast-forward
...
[](#Documentation/gitglossary.txt-aiddeffetchafetch)fetch

Fetching a [branch](#def_branch) means to get the branch’s [head ref](#def_head_ref) from a remote [repository](#def_repository), to find out which objects are missing from the local [object database](#def_object_database), and to get them, too. See also [git-fetch\[1\]](https://git-scm.com/docs/git-fetch).

[](#Documentation/gitglossary.txt-aiddeffilesystemafilesystem)file system

Linus Torvalds originally designed Git to be a user space file system, i.e. the infrastructure to hold files and directories. That ensured the efficiency and speed of Git.

[](#Documentation/gitglossary.txt-aiddefgitarchiveaGitarchive)Git archive

Synonym for [repository](#def_repository) (for arch people).

[](#Documentation/gitglossary.txt-aiddefgitfileagitfile)gitfile

A plain file `.git` at the root of a working tree that points at the directory that is the real repository.

[](#Documentation/gitglossary.txt-aiddefgraftsagrafts)grafts
...
[](#Documentation/gitglossary.txt-aiddefhashahash)hash

In Git’s context, synonym for [object name](#def_object_name).

[](#Documentation/gitglossary.txt-aiddefheadahead)head

A [named reference](#def_ref) to the [commit](#def_commit) at the tip of a [branch](#def_branch). Heads are stored in a file in `$GIT_DIR/refs/heads/` directory, except when using packed refs. (See [git-pack-refs\[1\]](https://git-scm.com/docs/git-pack-refs).)
...
[](#Documentation/gitglossary.txt-aiddefheadrefaheadref)head ref

A synonym for [head](#def_head).

[](#Documentation/gitglossary.txt-aiddefhookahook)hook

During the normal execution of several Git commands, call-outs are made to optional scripts that allow a developer to add functionality or checking. Typically, the hooks allow for a command to be pre-verified and potentially aborted, and allow for a post-notification after the operation is done. The hook scripts are found in the `$GIT_DIR/hooks/` directory, and are enabled by simply removing the `.sample` suffix from the filename. In earlier versions of Git you had to make them executable.

[](#Documentation/gitglossary.txt-aiddefindexaindex)index
...
[](#Documentation/gitglossary.txt-aiddefindexentryaindexentry)index entry
...
[](#Documentation/gitglossary.txt-aiddefmasteramaster)master
...
[](#Documentation/gitglossary.txt-aiddefmergeamerge)merge
...
[](#Documentation/gitglossary.txt-aiddefobjectaobject)object
...
[](#Documentation/gitglossary.txt-aiddefobjectdatabaseaobjectdatabase)object database
...
[](#Documentation/gitglossary.txt-aiddefobjectidentifieraobjectidentifier)object identifier

Synonym for [object name](#def_object_name).

[](#Documentation/gitglossary.txt-aiddefobjectnameaobjectname)object name
...
[](#Documentation/gitglossary.txt-aiddefobjecttypeaobjecttype)object type
...
[](#Documentation/gitglossary.txt-aiddefoctopusaoctopus)octopus

To [merge](#def_merge) more than two [branches](#def_branch).

[](#Documentation/gitglossary.txt-aiddeforiginaorigin)origin
...
[](#Documentation/gitglossary.txt-aiddefoverlayaoverlay)overlay
...
[](#Documentation/gitglossary.txt-aiddefpackapack)pack

A set of objects which have been compressed into one file (to save space or to transmit them efficiently).

[](#Documentation/gitglossary.txt-aiddefpackindexapackindex)pack index
...
[](#Documentation/gitglossary.txt-aiddefpathspecapathspec)pathspec
...
[](#Documentation/gitglossary.txt-top)top
...
[](#Documentation/gitglossary.txt-literal)literal

Wildcards in the pattern such as `*` or `?` are treated as literal characters.

[](#Documentation/gitglossary.txt-icase)icase

Case insensitive match.

[](#Documentation/gitglossary.txt-glob)glob
...
[](#Documentation/gitglossary.txt-attr)attr

After `attr:` comes a space separated list of "attribute requirements", all of which must be met in order for the path to be considered a match; this is in addition to the usual non-magic pathspec pattern matching. See [gitattributes[5]](https://git-scm.com/docs/gitattributes).
...
[](#Documentation/gitglossary.txt-aiddefparentaparent)parent
...
[](#Documentation/gitglossary.txt-aiddefpickaxeapickaxe)pickaxe

The term [pickaxe](#def_pickaxe) refers to an option to the diffcore routines that help select changes that add or delete a given text string. With the `--pickaxe-all` option, it can be used to view the full [changeset](#def_changeset) that introduced or removed, say, a particular line of text. See [git-diff\[1\]](https://git-scm.com/docs/git-diff).

[](#Documentation/gitglossary.txt-aiddefplumbingaplumbing)plumbing

Cute name for [core Git](#def_core_git).

[](#Documentation/gitglossary.txt-aiddefporcelainaporcelain)porcelain
...
[](#Documentation/gitglossary.txt-aiddefperworktreerefaper-worktreeref)per-worktree ref
...
[](#Documentation/gitglossary.txt-aiddefpseudorefapseudoref)pseudoref
...
[](#Documentation/gitglossary.txt-aiddefpullapull)pull

Pulling a [branch](#def_branch) means to [fetch](#def_fetch) it and [merge](#def_merge) it. See also [git-pull\[1\]](https://git-scm.com/docs/git-pull).

[](#Documentation/gitglossary.txt-aiddefpushapush)push
...
[](#Documentation/gitglossary.txt-aiddefreachableareachable)reachable
...
[](#Documentation/gitglossary.txt-aiddefreflogareflog)reflog
...
[](#Documentation/gitglossary.txt-aiddefrefspecarefspec)refspec

A "refspec" is used by [fetch](#def_fetch) and [push](#def_push) to describe the mapping between remote [ref](#def_ref) and local ref.

[](#Documentation/gitglossary.txt-aiddefremotearemoterepository)remote repository
...
[](#Documentation/gitglossary.txt-aiddefremotetrackingbrancharemote-trackingbranch)remote-tracking branch
...
[](#Documentation/gitglossary.txt-aiddefrepositoryarepository)repository
...
[](#Documentation/gitglossary.txt-aiddefresolvearesolve)resolve

The action of fixing up manually what a failed automatic [merge](#def_merge) left behind.

[](#Documentation/gitglossary.txt-aiddefrevisionarevision)revision

Synonym for [commit](#def_commit) (the noun).

[](#Documentation/gitglossary.txt-aiddefrewindarewind)rewind

To throw away part of the development, i.e. to assign the [head](#def_head) to an earlier [revision](#def_revision).

[](#Documentation/gitglossary.txt-aiddefSCMaSCM)SCM

Source code management (tool).

[](#Documentation/gitglossary.txt-aiddefSHA1aSHA-1)SHA-1
...
[](#Documentation/gitglossary.txt-aiddefshallowcloneashallowclone)shallow clone
...
[](#Documentation/gitglossary.txt-aiddefshallowrepositoryashallowrepository)shallow repository
...
[](#Documentation/gitglossary.txt-aiddefstashastashentry)stash entry
...
[](#Documentation/gitglossary.txt-aiddefsubmoduleasubmodule)submodule
...
[](#Documentation/gitglossary.txt-aiddefsuperprojectasuperproject)superproject
...
[](#Documentation/gitglossary.txt-aiddefsymrefasymref)symref
...
[](#Documentation/gitglossary.txt-aiddeftagatag)tag
...
[](#Documentation/gitglossary.txt-aiddeftagobjectatagobject)tag object
...
[](#Documentation/gitglossary.txt-aiddeftopicbranchatopicbranch)topic branch
...
[](#Documentation/gitglossary.txt-aiddeftreeatree)tree
...
[](#Documentation/gitglossary.txt-aiddeftreeobjectatreeobject)tree object
